...
const Footer = () => {
  ...
  return (
    ...
    >
      <i className='fas fa-copyright' /> {`${copyrightDate}`} <span><a href={siteConfig('LINK')} className='underline font-bold dark:text-gray-300 '>{siteConfig('AUTHOR')}</a>.<br/>
      ...
      <h1 className='text-xs pt-4 text-light-400 dark:text-gray-400'>L'Absurdité règne et l'amour en sauve.</h1>
